...
class Decorate extends _Events.Events {
  ...
  _decorateStorageEntry(creator, decorateMethod) {
    ...
    decorated.key = (...args) => (0, _util2.u8aToHex)((0, _util2.compactStripLength)(creator(creator.meta.type.isPlain ? undefined : creator.meta.type.isMap ? args[0] : creator.meta.type.isDoubleMap ? [args[0], args[1]] : args))[1]);

    decorated.keyPrefix = (...keys) => (0, _util2.u8aToHex)(creator.keyPrefix(...keys));
    ...
    if (creator.iterKey && (creator.meta.type.isMap || creator.meta.type.isDoubleMap)) {
      decorated.entries = decorateMethod((0, _util.memo)((0, _classPrivateFieldLooseBase2.default)(this, _instanceId)[_instanceId], (...args) => this._retrieveMapEntries(creator, null, args)));
      decorated.entriesAt = decorateMethod((0, _util.memo)((0, _classPrivateFieldLooseBase2.default)(this, _instanceId)[_instanceId], (hash, ...args) => this._retrieveMapEntries(creator, hash, args)));
      ...
      decorated.keys = decorateMethod((0, _util.memo)((0, _classPrivateFieldLooseBase2.default)(this, _instanceId)[_instanceId], (...args) => this._retrieveMapKeys(creator, null, args)));
      decorated.keysAt = decorateMethod((0, _util.memo)((0, _classPrivateFieldLooseBase2.default)(this, _instanceId)[_instanceId], (hash, ...args) => this._retrieveMapKeys(creator, hash, args)));
  ...
  _retrieveMapKeys({
    ...
    (0, _util2.assert)(iterKey && (meta.type.isMap || meta.type.isDoubleMap || meta.type.isNMap), 'keys can only be retrieved on maps, linked maps and double maps');
  ...
  _retrieveMapEntries(entry, at, args) {
    ...
    return this._retrieveMapKeys(entry, at, args).pipe((0, _operators.switchMap)(keys => keys.length ? (0, _xRxjs.combineLatest)((0, _util2.arrayChunk)(keys, PAGE_SIZE).map(query)).pipe((0, _operators.map)(valsArr => (0, _util2.arrayFlatten)(valsArr).map((value, index) => [keys[index], value]))) : (0, _xRxjs.of)([])));
  }
